<template>
  <div class="modal-background fade-in" @click.self="$emit('on:Close')">
    <div class="modal-container">
      ...
      <!-- El slot no puede recibir clases de CSS se puede  anidar con un div el contenido y a ese div asignarle la clase deseadaa -->
      <!-- <slot>
        <div class="center">Esto aparece si no tiene contenido</div>
      </slot> -->
    </div>
  </div>
</template>
